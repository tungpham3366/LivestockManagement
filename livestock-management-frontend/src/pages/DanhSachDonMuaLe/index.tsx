    ...
    <>
      <BasePages
        ...
        breadcrumbs={[
          ...
          { title: 'Danh sách đơn mua lẻ', link: '/danh-sach-goi-thau' }
        ]}
      >
        <div className="top-4 flex items-center justify-between space-y-2 "></div>
        <Tabs defaultValue="overview" className="space-y-4">
          <TabsList>
            <TabsTrigger value="overview">Danh sách đơn mua lẻ</TabsTrigger>
            <TabsTrigger value="add">Tạo đơn mua lẻ</TabsTrigger>
          </TabsList>
